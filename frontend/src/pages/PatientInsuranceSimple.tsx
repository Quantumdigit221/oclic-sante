...
export const PatientInsuranceManagement: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-slate-900 mb-6">Assurances Patients</h1>
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold text-slate-900">Liste des Assurances</h2>
          <button
        ...
        <div className="space-y-4">
          <div className="p-4 bg-slate-50 rounded-lg">
            <p className="text-slate-600">Aucune assurance patient enregistrée.</p>
            <p className="text-sm text-slate-500 mt-1">Cliquez sur "Nouvelle Assurance" pour commencer.</p>
          </div>
        </div>
      </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-2xl">
            <h3 className="text-lg font-semibold mb-4">Nouvelle Assurance Patient</h3>
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">Numéro de Police</label>
                  <input type="text" className="w-full px-3 py-2 border border-slate-200 rounded-lg" placeholder="POL-2024-001" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">Numéro d'Adhérent</label>
                  <input type="text" className="w-full px-3 py-2 border border-slate-200 rounded-lg" placeholder="MEM-001" />
                </div>
                <div>
