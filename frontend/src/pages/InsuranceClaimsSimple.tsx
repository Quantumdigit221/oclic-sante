...
export const InsuranceClaimsManagement: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-slate-900 mb-6">Réclamations Assurance</h1>
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold text-slate-900">Liste des Réclamations</h2>
          <button
        ...
        <div className="space-y-4">
          <div className="p-4 bg-slate-50 rounded-lg">
            <p className="text-slate-600">Aucune réclamation pour le moment.</p>
            <p className="text-sm text-slate-500 mt-1">Cliquez sur "Nouvelle Réclamation" pour commencer.</p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 border border-slate-200 rounded-lg">
                    <option>Sélectionner une consultation</option>
                  </select>
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">Montant Total (FCFA)</label>
                  <input type="number" className="w-full px-3 py-2 border border-slate-200 rounded-lg" placeholder="50000" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="text" className="w-full px-3 py-2 border border-slate-200 rounded-lg" placeholder="CLAIM-2024-001" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Notes</label>
                <textarea className="w-full px-3 py-2 border border-slate-200 rounded-lg" rows={3} placeholder="Notes sur la réclamation..."></textarea>
              </div>
