...
export const routes: RouteConfig[] = [
  ...
  {
    path: '/diagnostic',
    component: lazy(() => import('../pages/DiagnosticPage').then(m => ({ default: m.DiagnosticPage }))),
    roles: [Role.ADMIN, Role.SUPER_ADMIN, Role.DOCTOR, Role.RECEPTIONIST],
  },

  // Gestion Assurance & IMP - ADMIN A ACCES COMPLET
  {
    path: '/insurance/dashboard',
    component: lazy(() => import('../pages/InsuranceDashboardSimple').then(m => ({ default: m.InsuranceDashboardSimple }))),
    roles: [Role.ADMIN, Role.SUPER_ADMIN, Role.DOCTOR, Role.RECEPTIONIST],
  },
  {
    path: '/insurance/billing',
    component: lazy(() => import('../pages/InsuranceBillingSimple').then(m => ({ default: m.InsuranceBillingSimple }))),
    roles: [Role.ADMIN, Role.SUPER_ADMIN, Role.DOCTOR, Role.RECEPTIONIST],
  },
  {
    path: '/insurance/management',
    component: lazy(() => import('../pages/InsuranceManagementSimple').then(m => ({ default: m.InsuranceManagementSimple }))),
    roles: [Role.ADMIN, Role.SUPER_ADMIN, Role.DOCTOR, Role.RECEPTIONIST],
  },
  {
    path: '/insurance/reports',
    component: lazy(() => import('../pages/InsuranceReportsSimple').then(m => ({ default: m.InsuranceReportsSimple }))),
    roles: [Role.ADMIN, Role.SUPER_ADMIN, Role.DOCTOR, Role.RECEPTIONIST],
  },
  {
    path: '/insurance/patients',
    component: lazy(() => import('../pages/PatientInsuranceSimple').then(m => ({ default: m.PatientInsuranceSimple }))),
    roles: [Role.ADMIN, Role.SUPER_ADMIN, Role.DOCTOR, Role.RECEPTIONIST],
  },
  {
    path: '/insurance/claims',
    component: lazy(() => import('../pages/InsuranceClaimsSimple').then(m => ({ default: m.InsuranceClaimsSimple }))),
    roles: [Role.ADMIN, Role.SUPER_ADMIN, Role.DOCTOR, Role.RECEPTIONIST],
  },
];
